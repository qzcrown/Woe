export default {
  ...
  applications: {
    ...
    deleteConfirmWithName: '确定要删除应用 "{name}" 的图标吗？'
  },
  clients: {
    title: '客户端管理',
    add: '添加客户端',
  ...
  users: {
    ...
    placeholder: {
      name: '输入用户名',
      password: '输入密码',
      passwordOptional: '留空则保持不变',
      currentPassword: '请输入当前密码',
      newPassword: '请输入新密码',
      confirmPassword: '请再次输入新密码',
      nickname: '输入昵称',
      email: '输入邮箱地址',
      description: '输入用户描述（可选）'
    },
    loadingUsers: '正在加载用户...',
    noUsersFound: '暂无用户',
    administrator: '管理员',
    ...
    avatarDeleteError: '头像删除失败',
    pluginPermissions: '插件权限',
    permissionsSaved: '插件权限保存成功',
    permissionsSaveError: '保存插件权限失败',
    disable: '禁用',
    enable: '启用',
    disabled: '已禁用',
    enabled: '已启用',
    toggleDisabledError: '更改用户状态失败：{error}',
    avatarDeleteConfirm: '确定要删除用户头像吗？'
  },
  editApplication: {
    title: '编辑应用',
    name: '名称',
  ...
  applicationDetail: {
    ...
    tokenTitle: '应用令牌',
    tokenDescription: '使用此令牌通过 REST API 向该应用发送消息。',
    recentMessages: '最近消息',
    viewAllMessages: '查看全部消息',
    loadingMessages: '正在加载消息...',
    noMessagesTitle: '暂无消息',
    noMessagesDescription: '发送到该应用的消息将显示在此处。',
    noTitle: '无标题',
    loadMore: '加载更多',
    loadError: '加载应用失败',
  ...
  editProfile: {
    ...
    deleteAvatarConfirmTitle: '确认',
    deleteAvatarConfirmMessage: '确定要删除头像吗？',
    saveFailed: '保存失败'
  },
  plugins: {
    title: '插件管理',
    ...
    noPluginsFound: '暂无插件',
    pluginsDescription: '插件扩展了您的 Gotify 服务器的功能。联系管理员以添加插件。',
    learnMore: '了解插件',
    license: '许可证',
    website: '网站',
    capabilities: '功能',
    ...
    addPlugin: '添加插件',
    type: '插件类型',
    namePlaceholder: '例如：Webhooker-Slack',
    ...
    deleteError: '删除失败',
    nameUpdated: '插件名称已更新',
    nameUpdateError: '更新插件名称失败',
    iconUploaded: '插件图标已上传',
    iconUploadError: '上传图标失败',
    iconDeleted: '插件图标已删除',
    iconDeleteError: '删除图标失败',
    deleteIconConfirm: '确定要删除插件图标吗？',
    invalidFileType: '请选择图片文件',
    fileTooLarge: '图片大小不能超过 2MB',
    nameAlreadyExists: '该名称已被使用',
    editPlugin: '编辑插件',
    icon: '图标',
    configuration: '配置',
    configPlaceholder: '输入 YAML 配置...',
    updateSucceeded: '插件更新成功',
    updateError: '更新插件失败'
  },
